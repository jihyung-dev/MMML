...
(member_id, address_name, recipient_name, address_line1, address_line2, zipcode, phone, is_default)
VALUES
-- U001
('U001', '집',     '김철수', '서울특별시 강남구 테헤란로 101', '101동 1203호', '06236', '010-1111-0001', 1),
('U001', '회사',   '김철수', '서울특별시 강남구 역삼로 55',   '2층',          '06221', '010-1111-0001', 0),

-- U002
('U002', '본가',   '박영희', '서울특별시 송파구 올림픽로 300', 'A동 902호',   '05551', '010-2222-0002', 1),
('U002', '자취방', '박영희', '경기도 성남시 분당구 불정로 10', '네이버빌딩 7층','13561','010-2222-0002', 0),

-- U003
('U003', '집',     '이민수', '부산광역시 해운대구 센텀서로 30', '302호',       '48060', '010-3333-0003', 1),
('U003', '숙소',   '이민수', '부산광역시 해운대구 우동 123',     '5층',         '48094', '010-3333-0003', 0),

-- U004
('U004', '집',     '최다혜', '대구광역시 수성구 동대구로 300',   '1502호',      '42078', '010-4444-0004', 1),
('U004', '부모님댁','최다혜','대구광역시 중구 동성로 22',       '3층',         '41919', '010-4444-0004', 0),

-- U005
('U005', '집',     '정해준', '인천광역시 연수구 센트럴로 160',   '804호',       '22006', '010-5555-0005', 1),
('U005', '회사',   '정해준', '인천광역시 미추홀구 소성로 20',    '1층',         '22101', '010-5555-0005', 0);
commit;